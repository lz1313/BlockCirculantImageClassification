...
class AlexNet(object):
  ...
  def create(self):
    ...
    dropout6 = slim.dropout(
        fc6, self.KEEP_PROB, is_training=self.is_training, scope='dropout6')

    # 7th Layer: FC (w ReLu) -> Dropout
    fc7 = fc(dropout6, 4096, 4096, name='fc7')
    dropout7 = slim.dropout(
        fc7, self.KEEP_PROB, is_training=self.is_training, scope='dropout7')

    # 8th Layer: FC and return unscaled activations
    self.logits = fc(dropout7, 4096, self.NUM_CLASSES, relu=False, name='fc8')
